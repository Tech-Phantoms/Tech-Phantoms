...
const getMDXComponents = () => {
  return {
    ...
    pre: props => <div {...props} className={`${props.className || ''} px-1 py-0.5 bg-gray-200 text-gray-800 rounded font-mono text-sm`} />,
    inlineCode: props => <code {...props} className={`${props.className || ""}  px-1 py-0.5 bg-slate-600 `} />
  };
};