...
var Func = require('postcss-values-parser/lib/nodes/Func');
var Punctuation = require('postcss-values-parser/lib/nodes/Punctuation');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var Func__default = /*#__PURE__*/_interopDefaultLegacy(Func);
var Punctuation__default = /*#__PURE__*/_interopDefaultLegacy(Punctuation);
...
const hexa2rgba = node => {
  ...
  const rgbaFunc = Object.assign(new Func__default["default"]({
    name: 'rgba',
    raws: {}
  }), {
    raws: node.raws
  ...
  rgbaFunc.append(new Punctuation__default["default"]({
    value: ','
  }));
...
module.exports = postcssColorHexAlpha;
