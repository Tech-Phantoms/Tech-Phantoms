      ...
      >
        ...
        >
          ...
          <Box textAlign="justify">
            ...
            everyone who has that charisma for technology. With a clear vision
            to come up as a community where young developers kick start their
            journey towards Open Source.We strive towards building a learn by
            doing e nvironment where the learners are their own teachers and
            peer mentoring is promoted.
          </Box>
        </Box>
      </SimpleGrid>
    </div>
